    ...
    <main>
            ...
            <div class="container-xl">
                <nav>
                    <ol>
                        ...
                        <li><a href="cahier.php">Cahier</a></li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container1">
            <div class="filters">
                ...
                <!-- Sélection par type de cahier -->
<h3>Types de cahiers</h3>
<label>
    <input type="checkbox" name="notebook" value="cahier-ligné"> Cahier ligné
</label><br>
<label>
    <input type="checkbox" name="notebook" value="cahier-carreaux"> Cahier à carreaux
</label><br>
<label>
    <input type="checkbox" name="notebook" value="cahier-blanc"> Cahier blanc
</label><br>
<label>
    <input type="checkbox" name="notebook" value="cahier-musicale"> Cahier de musique
</label><br>
<label>
    <input type="checkbox" name="notebook" value="cahier-dessin"> Cahier de dessin
</label><br>
<label>
    <input type="checkbox" name="notebook" value="cahier-spirales"> Cahier à spirales
</label><br>
<label>
    <input type="checkbox" name="notebook" value="cahier-recette"> Cahier de recettes
</label><br>
<label>
    <input type="checkbox" name="notebook" value="cahier-bureau"> Cahier de bureau
</label><br>
<label>
    <input type="checkbox" name="notebook" value="cahier-personnalise"> Cahier personnalisé
</label><br>
<br>
            ...
            <div class="products">
              <div class="product">
                    <img src="images/liberta.png" alt="Produit">
                    <div class="product-details">
                        <h3>Cahier Brochure A4 144p </h3>
                        <p> 5/5 LIBERTA - Selecta</p>
                        <p>Prix: 11.900 DT</p>
                    </div>
                    <div class="actions">
                        <img src="images/cart.png" class="icon"  onclick="addToCart('30', 'Cahier Brochure ', '11.900', 'images/liberta.png')" alt="Ajouter au panier">
                        <img src="images/wishlist.png" class="icon" onclick="wishlist.addToWishlist('30', 'Cahier Brochure', '11.900', 'images/liberta.png')" alt="Favori">
                    </div>
                </div>
                <div class="product">
                    <img src="images/selecta.jpg" alt="Produit">
                    <div class="product-details">
                        <h3>Cahier Piqué Uni Rouge 24x32</h3>
                        <p>96 Pages - Selecta</p>
                        <p>Prix: 12.030 DT</p>
                    </div>
                    <div class="actions">
                        <img src="images/cart.png" class="icon" onclick="addToCart('31', 'Cahier Piqué Uni Rouge', '12.039', 'images/selecta.jpg')" alt="Ajouter au panier">
                        <img src="images/wishlist.png" class="icon" onclick="wishlist.addToWishlist('31', 'Cahier Piqué Uni Rouge', '12.039', 'images/selecta.jpg')" alt="Favori">
                    </div>
                </div>
                <div class="product">
                    <img src="images/aladin.jpg" alt="Produit">
                    <div class="product-details">
                        <h3> Cahier piqûre PM 96p seyès ALADIN </h3>
                        <p>Prix: 1.825 DT</p>
                    </div>
                    <div class="actions">
                        <img src="images/cart.png" class="icon" onclick="addToCart('32', 'Cahier piqûre PM', '1.825', 'images/aladin.jpg')" alt="Ajouter au panier">
                        <img src="images/wishlist.png" class="icon" onclick="wishlist.addToWishlist('32', 'Cahier piqûre PM', '1.825', 'images/aladin.jpg')" alt="Favori">
                    </div>
                </div>
                <div class="product">
                    <img src="images/spirale.jpg"  alt="Produit">
                    <div class="product-details">
                        <h3>Wiro PM 300p YAMAMA 80g</h3>
                        <p>Prix: 15 DT</p>
                    </div>
                    <div class="actions">
                        <img src="images/cart.png" class="icon" onclick="addToCart('33', 'Wiro PM 300p ', '15', 'images/spirale.jpg')" alt="Ajouter au panier">
                        <img src="images/wishlist.png" class="icon" onclick="wishlist.addToWishlist('33', 'Wiro PM 300p ', '15', 'images/spirale.jpg')" alt="Favori">
                    </div>
                </div>
                <div class="product">
                    <img src="images/spirale.jpg" alt="Produit">
                    <div class="product-details">
                        <h3>Wiro PM 100p YAMAMA 60g</h3>
                        <p></p>
                        <p>Prix: 8 DT</p>
                    </div>
                    <div class="actions">
                        <img src="images/cart.png" class="icon"  onclick="addToCart('34', 'Wiro PM 100p', '8', 'images/spirale.jpg')" alt="Ajouter au panier">
                        <img src="images/wishlist.png" class="icon" onclick="wishlist.addToWishlist('34', 'Wiro PM 100p', '8', 'images/spirale.jpg')" alt="Favori">
                    </div>
                </div>
                <div class="product">
                    <img src="images/sp.webp" alt="Produit">
                    <div class="product-details">
                        <h3>Cahier spiral PM 120p seyès SELECTA</h3>
                        <p></p>
                        <p>Prix: 5.35 DT</p>
                    </div>
                    <br>
                    <div class="actions">
                        <img src="images/cart.png" class="icon" onclick="addToCart('35', 'Cahier spiral PM', '5.35', 'images/sp.webp')" alt="Ajouter au panier">
                        <img src="images/wishlist.png" class="icon" onclick="wishlist.addToWishlist('6', 'Cahier spiral PM', '5.35', 'images/sp.webp')" alt="Favori">
                    </div>
                </div>
                <div class="product">
                    <img src="images/tp" alt="Produit">
                    <div class="product-details">
                        <h3>Cahier TP Wiro GM 288P </h3>
                        <p>seyès YAMAMA</p>
                        <p>Prix: 15 DT</p>
                    </div>
                    <br>
                    <div class="actions">
                        <img src="images/cart.png" class="icon" onclick="addToCart('36', 'Cahier TP Wiro', '15', 'images/tp')" alt="Ajouter au panier">
                        <img src="images/wishlist.png" class="icon" onclick="wishlist.addToWishlist('36', 'Cahier TP Wiro', '15', 'images/tp')" alt="Favori">
                    </div>
                </div>
